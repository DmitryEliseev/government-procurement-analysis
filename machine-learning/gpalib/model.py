...
def plot_confusion_matrixes(classifiers, normalize=False, title='Confusion matrix', figsize=(20, 10), cmap=plt.cm.Blues):
...
def transform_cros_val_scores(scores: dict):
    ...
    for key, value in scores.items():
        ...
        res['tst_acc'].append(np.mean(value['test_roc_auc']))
        res['tst_acc_std'].append(np.std(value['test_roc_auc']))
